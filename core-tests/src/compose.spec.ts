import { compose } from "@pfts/core/src";
...
describe("compose", () => {
  ...
  it("works with 10 fns", () => {
    const f = compose(add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(f(0)).toEqual(10);
  });

  it("works with 11 fns", () => {
    const f = compose(add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(f(0)).toEqual(11);
  });

  it("works with 12 fns", () => {
    const f = compose(add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(f(0)).toEqual(12);
  });

  it("works with 13 fns", () => {
    const f = compose(add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(f(0)).toEqual(13);
  });

  it("works with 14 fns", () => {
    const f = compose(add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(f(0)).toEqual(14);
  });

  it("works with 15 fns", () => {
    const f = compose(add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(f(0)).toEqual(15);
  });

  it("works with 16 fns", () => {
    const f = compose(add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
