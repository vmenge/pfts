import { pipe } from "@pfts/core/src";
...
describe("pipe", () => {
  ...
  it("works with 10 fns", () => {
    const a = pipe(0, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(a).toEqual(10);
  });

  it("works with 11 fns", () => {
    const a = pipe(0, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(a).toEqual(11);
  });

  it("works with 12 fns", () => {
    const a = pipe(0, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(a).toEqual(12);
  });

  it("works with 13 fns", () => {
    const a = pipe(0, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(a).toEqual(13);
  });

  it("works with 14 fns", () => {
    const a = pipe(0, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(a).toEqual(14);
  });

  it("works with 15 fns", () => {
    const a = pipe(0, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(a).toEqual(15);
  });

  it("works with 16 fns", () => {
    const a = pipe(0, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1, add1);
    expect(a).toEqual(16);
  });
